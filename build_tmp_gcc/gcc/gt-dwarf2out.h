...
{
  struct cached_dw_loc_list_def * const x = (struct cached_dw_loc_list_def *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_22cached_dw_loc_list_def, gt_ggc_e_22cached_dw_loc_list_def))
    {
...
{
  struct htab * const x = (struct htab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_P22cached_dw_loc_list_def4htab, gt_types_enum_last))
    {
      if ((*x).entries != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).size); i0++) {
        ...
        gt_pch_note_object ((*x).entries, x, gt_pch_p_P22cached_dw_loc_list_def4htab, gt_types_enum_last);
      }
    }
}
...
gt_pch_p_22cached_dw_loc_list_def (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct cached_dw_loc_list_def * const x ATTRIBUTE_UNUSED = (struct cached_dw_loc_list_def *)x_p;
  if ((void *)(x) == this_obj)
