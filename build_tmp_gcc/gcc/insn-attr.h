...
#define HAVE_ATTR_arch
enum attr_arch {ARCH_ANY, ARCH_A, ARCH_T, ARCH_32, ARCH_T1, ARCH_T2, ARCH_V6, ARCH_NOV6};
extern enum attr_arch get_attr_arch (rtx);

#define HAVE_ATTR_arch_enabled
enum attr_arch_enabled {ARCH_ENABLED_NO, ARCH_ENABLED_YES};
extern enum attr_arch_enabled get_attr_arch_enabled (rtx);

#define HAVE_ATTR_insn_enabled
...
#define HAVE_ATTR_arm_pool_range
extern int get_attr_arm_pool_range (rtx);
#define HAVE_ATTR_thumb2_pool_range
extern int get_attr_thumb2_pool_range (rtx);
#define HAVE_ATTR_arm_neg_pool_range
extern int get_attr_arm_neg_pool_range (rtx);
#define HAVE_ATTR_thumb2_neg_pool_range
