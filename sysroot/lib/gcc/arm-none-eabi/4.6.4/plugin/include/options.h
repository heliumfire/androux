...
enum opt_code
{
  ...
  OPT_mcallee_super_interworking = 953,      /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 954,      /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 955,       /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 956,                           /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 957,             /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 958,                     /* -mfloat-abi= */
  OPT_mfp16_format_ = 959,                   /* -mfp16-format= */
  OPT_mfp_ = 960,                            /* -mfp= */
  OPT_mfpe = 961,                            /* -mfpe */
  OPT_mfpe_ = 962,                           /* -mfpe= */
  OPT_mfpu_ = 963,                           /* -mfpu= */
  OPT_mhard_float = 964,                     /* -mhard-float */
  OPT_mlittle_endian = 965,                  /* -mlittle-endian */
  OPT_mlong_calls = 966,                     /* -mlong-calls */
  OPT_mpic_register_ = 967,                  /* -mpic-register= */
  OPT_mpoke_function_name = 968,             /* -mpoke-function-name */
  OPT_msched_prolog = 969,                   /* -msched-prolog */
  OPT_msingle_pic_base = 970,                /* -msingle-pic-base */
  OPT_msoft_float = 971,                     /* -msoft-float */
  OPT_mstructure_size_boundary_ = 972,       /* -mstructure-size-boundary= */
  OPT_mthumb = 973,                          /* -mthumb */
  OPT_mthumb_interwork = 974,                /* -mthumb-interwork */
  OPT_mtp_ = 975,                            /* -mtp= */
  OPT_mtpcs_frame = 976,                     /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 977,                /* -mtpcs-leaf-frame */
  OPT_mtune_ = 978,                          /* -mtune= */
  OPT_mvectorize_with_neon_quad = 979,       /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 980,               /* -mword-relocations */
  OPT_mwords_little_endian = 981,            /* -mwords-little-endian */
  OPT_n = 982,                               /* -n */
  OPT_no_canonical_prefixes = 983,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 984,               /* -no-integrated-cpp */
  OPT_nocpp = 985,                           /* -nocpp */
  OPT_nodefaultlibs = 986,                   /* -nodefaultlibs */
  OPT_nostartfiles = 987,                    /* -nostartfiles */
  OPT_nostdinc = 988,                        /* -nostdinc */
  OPT_nostdinc__ = 989,                      /* -nostdinc++ */
  OPT_nostdlib = 990,                        /* -nostdlib */
  OPT_o = 991,                               /* -o */
  OPT_p = 992,                               /* -p */
  OPT_pass_exit_codes = 993,                 /* -pass-exit-codes */
  OPT_pedantic = 994,                        /* -pedantic */
  OPT_pedantic_errors = 995,                 /* -pedantic-errors */
  OPT_pg = 996,                              /* -pg */
  OPT_pie = 997,                             /* -pie */
  OPT_pipe = 998,                            /* -pipe */
  OPT_print_file_name_ = 999,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 1000,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1001,          /* -print-multi-directory */
  OPT_print_multi_lib = 1002,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1003,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1004,                /* -print-multiarch */
